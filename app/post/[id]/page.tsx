        ...
        <div className="max-w-3xl mx-auto py-8 px-4">
            ...
            <div className="mb-8 mt-6">
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <p className="text-small text-gray-500">{new Intl.DateTimeFormat('en-GB', {
                        year: 'numeric',
                        month: 'long',
                        day: 'numeric',                       
            ...
            <div className="relative h-[400px] w-full mb-8 overflow-hidden rounded-lg">
                <Image src={data.imageUrl as string} alt="Image Hero" fill className="object-cover" priority />
            </div>
